...
const About = () => {
  return (
    <section className="px-4 mt-10 md:mt-24  md:pr-30 lg:mt-48 lg:pr-48 lg:pl-60">
      ...
      <p className="max-w-screen font-semi-bold text-slate-900 text-xl dark:text-slate-200 text-slate-700 mb-8 lg:text-2xl font-semi-bold transition ease-in-out"> I have a passion for Web Development and Japanese. After learning Javascript during my Bachelor's Degree in Japan at Yamanashi Gakuin University, 
