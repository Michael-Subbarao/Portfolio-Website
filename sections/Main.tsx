...
const Main = (href) => {
  ...
  return (
    <section className="h-96 mt-20 md:mt-24 md:pr-60 md:pl-60 ">
      ...
      <h3 className="text-4xl my-3 transition ease-in-out">I am Full Stack Web Developer</h3>
      <p className="text-slate-900 dark:text-slate-100 mb-8 transition ease-in-out"> I specialize in the PERN stack (PostgreSQL, Express, React, Node).</p>
      <Button 
