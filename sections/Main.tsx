...
const Main = (href) => {
  ...
  return (
    <section className="mt-10 md:mt-32 px-4 md:pr-30 lg:mt-64 lg:pr-60 lg:pl-60 ">
      ...
      <p className="max-w-screen lg:text-2xl font-semi-bold text-slate-900 dark:text-slate-100 mb-8 transition ease-in-out"> I specialize in the PERN stack (PostgreSQL, Express, React, Node). Check out some of my work!</p>
      <Button 
